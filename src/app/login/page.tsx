...
export default async function LoginPage(props: PageProps<"/login">) {
  ...
  return (
    <main className="grid h-dvh overflow-hidden bg-gradient-to-br from-blue-50 via-white to-slate-50 px-4 py-4 sm:px-6 lg:grid-cols-[minmax(520px,1fr)_minmax(380px,520px)] lg:items-center lg:gap-8 lg:px-10 xl:px-24">
      <section className="mx-auto hidden w-full max-w-2xl lg:block">
        <div className="flex items-center gap-3 text-emerald-800">
          <Users className="h-8 w-8 shrink-0 xl:h-10 xl:w-10" />
          <span className="text-3xl font-bold xl:text-5xl">Controle Familiar</span>
        </div>
        <h1 className="mt-5 text-4xl font-semibold leading-tight tracking-normal text-slate-950 xl:mt-8 xl:text-5xl">
          Controle seus gastos de forma simples
        </h1>
        <p className="mt-3 max-w-xl text-lg leading-7 text-slate-600 xl:mt-5 xl:text-2xl xl:leading-9">
          Transforme a gestao financeira da sua casa em um momento de uniao. Simples, transparente e feito para a vida real.
        </p>

        <div className="mt-5 aspect-[16/9] max-h-[34vh] min-h-56 overflow-hidden rounded-lg border border-emerald-100 bg-[#f7d9a8] shadow-xl xl:mt-8 xl:max-h-[360px]">
        ...
        <div className="mt-4 grid max-w-xl grid-cols-3 gap-3 xl:mt-6">
      ...
      <section className="flex min-h-0 items-center justify-center">
        <Card className="w-full max-w-md overflow-hidden rounded-2xl border-slate-200 bg-white/95 shadow-2xl">
          <CardHeader className="space-y-1 px-5 pb-3 pt-5 sm:px-8 sm:pt-8">
            ...
            <CardContent className="grid gap-4 px-5 sm:px-8">
              <div className="grid gap-2">
                ...
                <div className="relative">
                  ...
                  <Input id="email" name="email" type="email" placeholder="nome@email.com" className="h-14 rounded-xl pl-14 text-base" required />
                </div>
              </div>
              <div className="grid gap-2">
                ...
                <div className="relative">
                  ...
                  <Input id="password" name="password" type="password" placeholder="********" className="h-14 rounded-xl px-14 text-base" required />
              ...
              <Button type="submit" className="h-14 rounded-xl bg-emerald-700 text-base hover:bg-emerald-800">
                Entrar
                <ArrowRight className="h-5 w-5" />
              </Button>
            </CardContent>
          </form>
          <CardFooter className="justify-center border-t bg-blue-50/70 p-4">
